...
segs, info = m.transcribe(r"D:\video editor\_audit\Video 4\audio\audio.wav", language="en", word_timestamps=True, beam_size=1, vad_filter=False)
...
with open(r"D:\video editor\_audit\Video 4\audio\transcript.json", "w", encoding="utf-8") as f:
