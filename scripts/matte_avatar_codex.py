#!/usr/bin/env python3
"""Matte avatar_codex.mp4 (46.5 s) -> public/matted_avatar_codex/mat_%04d.png."""
...
AVATAR = Path(r"D:/video editor/remotion-studio/public/avatar_codex.mp4")
FFMPEG = Path(
    r"C:/Users/Asus/AppData/Roaming/Python/Python312/site-packages/"
    r"imageio_ffmpeg/binaries/ffmpeg-win-x86_64-v7.1.exe"
)
WORK = Path(r"D:/video editor/_audit/Video 3/matte")
OUT = Path(r"D:/video editor/remotion-studio/public/matted_avatar_codex")
...
def main() -> int:
    ...
    print("[3/3] Upscaling matted seq -> public/matted_avatar_codex/", file=sys.stderr, flush=True)
    subprocess.run(
        [
