#!/usr/bin/env python3
"""Matte avatar_v4.mp4 (42 s Canva-pipeline reel) -> public/matted_avatar_v4/mat_%04d.png."""
...
AVATAR = Path(r"D:/video editor/remotion-studio/public/avatar_v4.mp4")
FFMPEG = Path(
    r"C:/Users/Asus/AppData/Roaming/Python/Python312/site-packages/"
    r"imageio_ffmpeg/binaries/ffmpeg-win-x86_64-v7.1.exe"
)
WORK = Path(r"D:/video editor/_audit/Video 4/matte")
OUT = Path(r"D:/video editor/remotion-studio/public/matted_avatar_v4")
...
def main() -> int:
    ...
    print("[2/3] Running rembg u2net...", file=sys.stderr, flush=True)
    ...
    print("[3/3] Upscaling to 1080 width -> public/matted_avatar_v4/", file=sys.stderr, flush=True)
    subprocess.run(
        [
